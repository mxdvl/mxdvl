...
export class ReadonlyDate {
	 ...
	 * @param {number} [month] - Month (0-11, UTC). Must be provided if first arg is a year
	 * @param {number} [day=1] - Day of month (1-31, UTC). Defaults to 1
	 * @example
	 * ```js
	 * new ReadonlyDate(1706356800000); // timestamp
	 * new ReadonlyDate(2024, 0, 27);   // year, month, day (UTC)
	 * new ReadonlyDate(2024, 0);       // year, month (day defaults to 1)
	 * ```
	 */

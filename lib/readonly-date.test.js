...
Deno.test({
	...
	fn() {
		...
		assertThrows(
			() => new ReadonlyDate(),
			TypeError,
			"ReadonlyDate constructor expects 1 argument (timestamp) or 3 arguments (year, month, day), got 0",
		);
		...
		assertThrows(
			...
			TypeError,
			"ReadonlyDate constructor expects 1 argument (timestamp) or 3 arguments (year, month, day), got 2",
		);
		...
		assertThrows(
			...
			TypeError,
			"ReadonlyDate constructor expects 1 argument (timestamp) or 3 arguments (year, month, day), got 4",
		);
	},
});

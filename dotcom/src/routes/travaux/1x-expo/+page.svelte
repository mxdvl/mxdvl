<script lang="ts">
	...
	import { date, title } from "../../works/1x-expo/+page.svelte";

	const en = "/works/1x-expo";
</script>

<Alternates fr={$page.url.pathname} {en} />
...
<section lang="en">
	...
	<p>
		Exhibition design at the Université de Montréal showcasing the various models and modes of explorations for five
		ongoing projects at Provencher_Roy.
	</p>

	<Image path={en} ratio={4 / 6} src="1x-expo-model.jpg" alt="model of the expo" />
	...
	<Image path={en} ratio={4 / 6} src="1x-expo-model-side.jpg" alt="another view of the model" />
